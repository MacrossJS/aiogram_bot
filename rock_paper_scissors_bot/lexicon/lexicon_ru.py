LEXICON_RU: dict[str, str] = {
    ...
    'inline_buttons': 'Вот {} тебе ссылки!',
    'callback_buttons': '{}, это каллбэк кнопки!'}
...
LEXICON_COMMANDS_RU: dict[str, str] = {
                ...
                '/urls': 'Инлайн кнопки со ссылками',
                '/callback': 'Инлайн кнопки со ссылками',
                '/delmenu': 'Удалить кнопку Menu'}
